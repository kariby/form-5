/*  
Строка 9 - Включается число лиц, получивших ревакцинацию против дифтерии (любой из туров RV1, RV2, RV3, RVn, RV) 
*/
-- tab=Строка 9
...
/*  
Строка 10 - Включается число детей, получивших ревакцинацию против дифтерии (любой из туров RV1, RV2, RV3, RVn, RV) 
*/
-- tab=Строка 10
select count(distinct p.id) from PACIENTS p
inner join VACCINE_CARDS vc on p.ID = vc.PACIENT_ID and vc.ENABLED = 1
